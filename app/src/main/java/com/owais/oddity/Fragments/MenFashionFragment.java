...
public class MenFashionFragment extends Fragment {
    ...
    final private static int parent=540;
...
//    AVLoadingIndicatorView avLoadingIndicatorView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_men_fashion, container, false);
        getActivity().setTitle("Men Fashion");
        listing=new ArrayList<>();
        progressBar=view.findViewById(R.id.progressbar_menFashion);
        recyclerView = view.findViewById(R.id.recyclerview_menFashion);
...
//        recyclerView.setItemAnimator(new DefaultItemAnimator());
        ...
        context=getActivity();
//        avLoadingIndicatorView=view.findViewById(R.id.loadingIndicator_menFashion);
        productAdapter = new ProductAdapter(listing,context,this);
        mShimmerViewContainer = view.findViewById(R.id.shimmer_menFashion);
        layoutNoInternet =  view.findViewById(R.id.layout_noconnection_menFashion);
        layoutHomeLiving =  view.findViewById(R.id.layout_menFashion);
