 ...
 */
public class OddityDealsFragment extends Fragment {

    final private static int parent=205;
...
//    AVLoadingIndicatorView avLoadingIndicatorView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_oddity_deals, container, false);
        getActivity().setTitle("Oddity Deals");

        listing=new ArrayList<>();
        progressBar=view.findViewById(R.id.progressbar_oddityDeals);
        recyclerView = view.findViewById(R.id.recyclerview_oddityDeals);
        mLayoutManager = new GridLayoutManager(context, 2);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(mLayoutManager);
        context=getActivity();
//        avLoadingIndicatorView=view.findViewById(R.id.loadingIndicator_oddityDeals);
        mShimmerViewContainer = view.findViewById(R.id.shimmer_oddityDeals);
        productAdapter = new ProductAdapter(listing,context,this);
        layoutNoInternet =  view.findViewById(R.id.layout_noconnection_oddityDeals);
        layoutHomeLiving =  view.findViewById(R.id.layout_oddityDeals);
